...
def add_playlist(youtube, args):
    ...
    body = dict(snippet=dict(title=args.title, description=args.description), status=dict(privacyStatus="private"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--title", default="Test Playlist", help="The title of the new playlist.")
    parser.add_argument(
        "--description",
